                            ...
                            <form class="form" id="job-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="job_title" placeholder="Type"/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="county" id="Location">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="Description" name="job_desc" rows="3"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label>Date Range:</label>
                                        <div>
                                            <input type='text' class="form-control" name="job_start_end_date" id="kt_daterangepicker_1" readonly placeholder="Select time" type="text"/>
                                        </div>
                                    </div>
                                </div>
