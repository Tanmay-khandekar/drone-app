...
<section class="htc__team__area ptb--50 bg__white">
    <div class="htc__team__container">
        <div class="container">
            ...
            <div class="row">
                <div class="htc__team__wrap clearfix">
                    <!-- Start Single Team -->
                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
                        <div class="team foo">
                            ...
                            <div style="padding: 30px;" class="bg__gray">
                                ...
                                <p style="color:black;"> <i style="margin-right: 5px;" class="fa fa-check-square-o"></i><strong>License: </strong>Not specified</p>
                                <p style="color:black;"> <i style="margin-right: 5px;" class="fa fa-usd"></i><strong>Avg. Rate: $150/hr </strong></p>
                                <hr>
                                <div>
